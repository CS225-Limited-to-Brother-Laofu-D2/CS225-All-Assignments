...
public:
    vertex(T item = 0, int col = -1, vertex<T> *pt_next = 0, vertex<T> *pt_prev = 0);
...
public:
    ...
    int getcolour(T node);
    void setcolour(T node, int col);
    elist<T> * edges(T node);
    edgelist<T> * outgoingedges(T item);
    AList<T> * getlist(void);
    AList<T> * getuncolouredlist(void);
    bool colourable(vertexlist<T> *nodes, int col);
...
public:
    ...
    int getcolour(vertexlist<T> * vertices);
private:
    T secondvertex;
    neighbour<T> * next;
...
public:
    ...
    bool is_colourable(vertexlist<T> *vertices, int col);
private:
    neighbour<T> * first;
    int length;
};
...
public:
    ...
    deepsearchtree<T> * colouring(void);
    void greedycolouring(void);
private:
    deepsearchtree<T> * colourwith(int colour);
    void greedy(int colour);
    void dfsnew (T startnode, AList<T> *startlist, deepsearchtree<T> *output, int colour);
    void _dfs(T node1, T node2, AList<T> *startlist, vertexlist<T> * vertices, deepsearchtree<T> * output, markerlist<T> * markedvertices, int &dfspos, int &finishingtime, int colour);
