...
//有向图的基本操作以及DFS &BFS, 仅存在outgoingedge, 
// DFS操作看这里的.cpp
// 本.h文件的相应注释可完全参考环的检测的.h文件

#ifndef digraph_h
#define digraph_h
// 与无向图的唯二区别在于addedge和deleteedge时, 无向图需要同时对两条outgoing边操作
// 除此之外,无向图相当于有向图每条边都是双向边.
...
public:
    ...
    AList<deeptreenode<T>*>* tsort(T startnode);
private:
